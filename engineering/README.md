...
| **YAML (P2KB)** | [dashboard](operations/YAML-HEAD-DASHBOARD.md) · [register](operations/P2KB-CORRECTION-FINDINGS.md) | **v1.18.2** shipped 2026-09-11 — board and example entries state facts, not grades (F-374/F-425); the DoD suite gained a 12th blocking gate | Next correction/enrichment as findings land |
