...
| **Manual** | [`document-production/README.md`](document-production/README.md) · [roster](document-production/PUBLICATION-ROSTER.md) | 7 live manuals + 6 app-notes · **I/O & Smart Pins v1.0.3**, **P2AN005/006 v1.0.0** latest · Single-Step in review | Architect's Guide draft review; then XBYTE guide |
