...
| **Manual** | [`document-production/README.md`](document-production/README.md) · roster → [`PUBLICATION-ROSTER.md`](document-production/PUBLICATION-ROSTER.md) | Assembly **v3.1.1** ✅ + DeSilva **v3.0.1** ✅ + Debug-Window **v1.0.1** ✅ + Streamer **v1.0.2** ✅ shipped · Single-Step in **tech review** (cover repaired 2026-06-12) | **PASM/Assembly ref is DONE** (chip review is external). Next owned work: I/O & Smart Pins User Guide initial draft |
