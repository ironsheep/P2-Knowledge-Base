...
| **YAML (P2KB)** | [dashboard](operations/YAML-HEAD-DASHBOARD.md) · [register](operations/P2KB-CORRECTION-FINDINGS.md) | **v1.19.1** shipped 2026-09-19 — the streamer's `$FFFF` perpetual count, which v1.19.0's notes claimed and did not carry (F-440) | Next correction/enrichment as findings land |
