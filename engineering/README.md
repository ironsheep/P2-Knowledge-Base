...
| **Manual** | [`document-production/README.md`](document-production/README.md) · roster → [`PUBLICATION-ROSTER.md`](document-production/PUBLICATION-ROSTER.md) | Getting-Started **v1.0.0** ✅ + Assembly **v3.1.1** ✅ + DeSilva **v3.0.1** ✅ + Debug-Window **v1.0.1** ✅ + Streamer **v1.0.3** ✅ + **I/O & Smart Pins v1.0.0 ✅ shipped 2026-07-03** · Single-Step in **tech review** | **I/O & Smart Pins User Guide released (maiden v1.0.0)** — cross-ref filter pilot. Next owned work: Architect's Guide + XBYTE guide; P2AN app-note series — **P2AN001 v1.0.1 + P2AN002 v1.0.0 + P2AN003 v1.0.0 ✅ released 2026-07-03** (ADC + CORDIC + DAC; companion-schema pilot); P2AN004 next in the same wave |
