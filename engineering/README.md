...
| **Manual** | [`document-production/README.md`](document-production/README.md) · [roster](document-production/PUBLICATION-ROSTER.md) | 8 live manuals + 6 app-notes · **Architect's Guide v1.0.0 shipped 2026-07-08** (maiden) · correction wave 2026-07-07: I/O & Smart Pins v1.0.4, Streamer v1.0.5, Debug v1.0.2, DeSilva v3.0.2 · Single-Step in review | XBYTE guide |
