...
| **YAML (P2KB)** | [dashboard](operations/YAML-HEAD-DASHBOARD.md) · [register](operations/P2KB-CORRECTION-FINDINGS.md) | **v1.19.0** shipped 2026-09-19 — examples that would not assemble now do, `ABORT`/trap semantics match the interpreter, and downloads no longer carry our provenance | Next correction/enrichment as findings land |
