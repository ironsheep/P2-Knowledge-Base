...
| **Manual** | [`document-production/README.md`](document-production/README.md) · [roster](document-production/PUBLICATION-ROSTER.md) | **18 published** · 9 manuals · 7 app-notes · 1 guide · 1 tool-guide — latest **I/O & Smart Pins v1.0.10**, 2026-09-11 | **v1.18.0 wave in flight** — 7 of 8 released; Assembly is the last, by his hand |
