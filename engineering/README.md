...
| **Manual** | [`document-production/README.md`](document-production/README.md) · [roster](document-production/PUBLICATION-ROSTER.md) | **18 published** · 9 manuals · 7 app-notes · 1 guide · 1 tool-guide — latest **Assembly Reference v3.1.10**, 2026-09-22 | **deSilva v3.0.8 owes one Forge pass** (margin gate RED on the returned PDF) |
