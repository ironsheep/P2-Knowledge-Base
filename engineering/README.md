...
| **YAML (P2KB)** | [dashboard](operations/YAML-HEAD-DASHBOARD.md) · [register](operations/P2KB-CORRECTION-FINDINGS.md) | **v1.18.1** shipped 2026-09-10 — CORDIC result formats re-derived from the Silicon Doc (F-416/F-419); v1.18.0 made cite-or-omit policy | Next correction/enrichment as findings land |
| **Manual** | [`document-production/README.md`](document-production/README.md) · [roster](document-production/PUBLICATION-ROSTER.md) | **18 published** · 9 manuals · 7 app-notes · 1 guide · 1 tool-guide — latest **P2AN001 v1.0.5** + **P2AN002 v1.0.4**, 2026-09-11 | **v1.18.0 wave in flight** — 2 of 8 released; 6 staged in outbound, Assembly last |
