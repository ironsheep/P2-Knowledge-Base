...
> **Predecessor.** This file replaced the 2025-08-15 audit of the PDF-era capture
> (*"P2 Silicon Documentation v35 — Complete Extraction & Audit"*, 8,116 bytes). That audit is
> **preserved verbatim** at `archive/silicon-doc-complete-extraction-audit-2025-08-15.md`.
> 21 references to this filename exist elsewhere in the repo (`engineering/history/`,
> `ingestion-metadata/`, `CLEANUP-NEEDED.md`, …); most describe the 2025 state, so they are
> pointed at the archived copy rather than silently re-aimed at this one.
