...
- **What's next:** **wave the tail** — datasheet completion, deSilva, PE Labs, XBee (+errata), app notes (**5/17 done 2026-06-27**: AN001/004/008/013/014; 12 await PDFs) — via `ingest-conductor` → `ingest-wrap-reduce` against the now-populated frame.
