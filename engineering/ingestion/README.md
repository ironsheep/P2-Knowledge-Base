...
- **By authority:** 🏆 22 · 🟢 6 · 🟡 4  ‹32 logical sources; v51a lineage + 3 non-source folders excluded; hyperRam promoted 🟢→🏆 on ingestion›
...
- **Latest ingested:** **HyperRAM/HyperFlash Add-on (#64004-ES)** (2026-06-22, 🏆 — forced-OCR, PDF-only ladder) · prior: Smart Pins (Titus) rev 5 (2026-06-12, 🟡) ‹LIN›
