# PNut-Term-TS User Guide — pre-release development history

> **Frozen archive. Not the changelog.** This is the development log kept while the
> guide was being written, from the seeded element through the tool-developer review
> draft. It stops at the **v1.0.0** public release; the live changelog is
...
> at the time. Do not reformat its headings, trim its entries to the length budget,
> or apply the guide to it retroactively — editing it destroys the only thing it is
> good for. It does **not** ship with the document.
