...
(Appendix C's minimal community example, §C.9, is a reusable cog that does exactly this.)
:::
...
Chapter 15 builds an illustrative 6502 slice at rung 3. **Marco Maccaferri's `M6502`** is the
