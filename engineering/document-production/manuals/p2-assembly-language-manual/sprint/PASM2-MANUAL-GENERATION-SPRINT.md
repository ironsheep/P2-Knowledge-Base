...
### 5.1 Opus Master (Authoritative Content)

The **Opus Master** folder contains all production markdown - the source of truth for document content. This lives in the versioned manuals tree, not the workspace.

```
/engineering/document-production/manuals/p2-assembly-language-manual/opus-master/
├── README.md                           # Opus Master documentation
...
**Why "Opus Master":** Content is generated by Opus model, this is the master/authoritative copy, and it's versioned in git (unlike workspace which may have transient files).

### 5.2 Workspace Structure (PDF Production)

The workspace is for PDF generation - templates, assembled documents, and deployment files.

```
/engineering/document-production/workspace/p2-assembly-language-manual/
├── README.md                           # Workspace quick reference
├── P2-Assembly-Language-Manual.md      # Assembled master (from opus-master parts)
├── templates/
...
### 5.3 Assembly Strategy

Content flows from Opus Master to Workspace for PDF generation:
```bash
# Assemble from opus-master into workspace
cat opus-master/front-matter.md opus-master/part-i/*.md opus-master/part-ii/*.md opus-master/part-iii/*.md > workspace/P2-Assembly-Language-Manual.md
```

Or use Pandoc's multi-file input capability.

**Key distinction:**
- **Opus Master** = Source markdown (versioned, authoritative)
- **Workspace** = PDF production (templates, assembled output, deployment)
...
*Version: 1.3 - Added Opus Master folder structure*
...
| 1.3 | 2025-11-28 | Added Opus Master folder structure - authoritative markdown in manuals tree, workspace for PDF production |
