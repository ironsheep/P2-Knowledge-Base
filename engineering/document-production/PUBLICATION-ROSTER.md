...
2026-07-15 23:00  PUBLISH   p2-io-and-smart-pins-user-guide  (v1.0.6, 396pp — three Silicon-Doc-grounded scope/DAC clarifications: scope-mode filter DC dynamic range ~5–6 bits/filter (ch16 §16.5 + App F), DAC dither fed every clock vs the separate sample-period timer (ch10 §10.4), X=0 low-power rationale for DAC noise (ch18 §18.3); KB twin v1.14.4. Render-verified: outline complete (19 ch + A–G + Index), all 3 callouts text-present + scope page eyeballed, compile-clean 0 LaTeX errors, +1.6k chars vs v1.0.5 so the −2pp is reflow not drop. Examples unchanged (-src-260712 stands))
...
|--------|-----|:--:|-----|
| `p2-debug-window-manual` | 1.1.0 | ✅ current | rebuilt 07-14 (silicon-verification sweep; 169pp) |
...
| `p2-io-and-smart-pins-user-guide` | 1.0.6 | ✅ current | rebuilt 07-15 (scope/DAC Silicon-Doc clarifications; KB v1.14.4) |
