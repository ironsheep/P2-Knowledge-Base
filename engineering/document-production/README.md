...
| App note | Slug | State |
|----------|------|-------|
| P2AN001 — Single-Pin ADC Instrumentation | `P2AN001` | ✅ **v1.0.0 released 2026-07-03** (20pp) — exemplar + companion-schema pilot (Family A0); ships YAML companion + example ZIP |
