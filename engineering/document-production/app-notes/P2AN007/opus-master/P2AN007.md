...
- Build with DEBUG enabled — `pnut-ts -d`.
...
- **Example library** — every recipe as a standalone, `pnut-ts`-compiled program, published as `P2AN007-src.zip` beside this note:
