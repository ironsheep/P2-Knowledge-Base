# Workspace — P2AN005 (Application Note)

Production-preparation workspace for the **P2AN005** application note. This is the
...
```
app-notes/P2AN005/opus-master/   ← CONTENT AUTHORING (front-matter.md + P2AN005.md)   authoritative
workspace/P2AN005/               ← PRODUCTION PREPARATION (this folder)
outbound/P2AN005/                ← STAGING FOR PDF FORGE
```

## Canonical name

`P2AN005` — used identically for the workspace folder, the outbound folder, the
...
| File | Purpose |
|------|---------|
| `assemble-manual.sh` | Concatenates `front-matter.md` (cover) + `P2AN005.md` (body) from the app-note opus-master into `P2AN005.md` here. |
| `P2AN005.md` | The assembled working copy (generated — do not edit; edit opus-master). |
...
```
./assemble-manual.sh
../../../tools/conversion/latex-escape-all.sh P2AN005.md      # or via prepare-manual
# stage changed files to ../../outbound/P2AN005/ ; user moves outbound -> Forge
```
