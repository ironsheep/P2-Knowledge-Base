#!/bin/bash
# The P2 Architect's Guide Assembly Script
...
OPUS_MASTER="../../manuals/p2-architect-guide/opus-master"
OUTPUT="P2-Architect-Guide.md"

echo "========================================"
echo "The P2 Architect's Guide Assembly"
echo "========================================"
echo ""
