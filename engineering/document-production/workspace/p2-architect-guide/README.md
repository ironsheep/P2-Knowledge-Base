...
../../manuals/p2-architect-guide/opus-master/
  ...
  └── architect-guide-body.md    # Ch1–3 + Appendix A/B + Glossary + Where-to-Next (single-file, DD3)
```
...
| `templates/p2kb-architect-diagrams.sty` | TikZ stub (inert — no `\Diag*` macros for v0.1.0; DD5) |
...
| Item | Status |
|------|--------|
| Charter / creation-guide / voice-guide | **Complete** — `../../manuals/p2-architect-guide/{PLANNING,creation-guide,voice-guide}.md` |
