# Workspace — P2AN007 (Application Note)

Production-preparation workspace for the **P2AN007** application note. This is the
...
```
app-notes/P2AN007/opus-master/   ← CONTENT AUTHORING (front-matter.md + P2AN007.md)   authoritative
workspace/P2AN007/               ← PRODUCTION PREPARATION (this folder)
outbound/P2AN007/                ← STAGING FOR PDF FORGE
```

## Canonical name

`P2AN007` — used identically for the workspace folder, the outbound folder, the
...
| File | Purpose |
|------|---------|
| `assemble-manual.sh` | Concatenates `front-matter.md` (cover) + `P2AN007.md` (body) from the app-note opus-master into `P2AN007.md` here. |
| `P2AN007.md` | The assembled working copy (generated — do not edit; edit opus-master). |
...
```
./assemble-manual.sh
../../../tools/conversion/latex-escape-all.sh P2AN007.md      # or via prepare-manual
# stage changed files to ../../outbound/P2AN007/ ; user moves outbound -> Forge
```
