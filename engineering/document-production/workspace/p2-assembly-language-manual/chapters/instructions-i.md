...
INCMOD does not limit Dest within the specified range. If Dest begins at a value greater than Src, iterations of INCMOD will continue to increment it through the 32-bit rollover point (\$FFFF\textbackslash\{\}\_FFFF wrapping to \$0000\textbackslash\{\}\_0000) before it will effectively cycle from 0 to Src.
