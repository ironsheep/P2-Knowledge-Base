...
The format of Dest for Debug ISR use is \%AAAAAAAAAAAAAAAAAAAA\_BCDEFGHIJKLM where A is the 20-bit breakpoint address or 4-bit event code, and bits B-M control various interrupt enable conditions.
