...
declare -a REQUIRED_FILES=(
    ...
    "part-iii/appendix-b-condition-codes.md"
    "part-iii/appendix-c-categorical-index.md"
    "part-iii/appendix-d-special-registers.md"
    "part-iii/appendix-e-constants.md"
    "part-iii/appendix-f-smartpin-constants.md"
    "part-iii/appendix-g-streamer-constants.md"
    "part-iii/appendix-h-reserved-words.md"
    "part-iii/appendix-i-glossary.md"
    "part-iii/appendix-j-known-bugs.md"
)
...
assemble_section "part-iii/appendix-b-condition-codes.md" "Appendix B: Condition Codes"
assemble_section "part-iii/appendix-c-categorical-index.md" "Appendix C: Categorical Index"
assemble_section "part-iii/appendix-d-special-registers.md" "Appendix D: Special Registers"
assemble_section "part-iii/appendix-e-constants.md" "Appendix E: Predefined Constants"
assemble_section "part-iii/appendix-f-smartpin-constants.md" "Appendix F: Smart Pin Mode Constants"
assemble_section "part-iii/appendix-g-streamer-constants.md" "Appendix G: Streamer Mode Constants"
assemble_section "part-iii/appendix-h-reserved-words.md" "Appendix H: Reserved Words"
assemble_section "part-iii/appendix-i-glossary.md" "Appendix I: Glossary"
assemble_section "part-iii/appendix-j-known-bugs.md" "Appendix J: Known Silicon Bugs"
...
echo "  - Part III (Reference Tables): 10 appendices"
echo ""
