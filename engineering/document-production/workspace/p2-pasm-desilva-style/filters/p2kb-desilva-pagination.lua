-- P2KB DeSilva - Pagination Filter (COPIED FROM PROVEN SMART PINS)
-- Purpose: ONLY handles page breaks between Parts, Chapters, and Appendices
-- No code block processing - single responsibility
--
-- Version: 1.0 - Copied from Smart Pins p2kb-sp-pagination.lua (proven working)
-- Date: 2025-09-16
-- Source: Smart Pins workspace filter chain
