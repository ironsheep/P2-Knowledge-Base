#!/bin/bash
# P2 XBYTE Programming Guide Assembly Script
...
OPUS_MASTER="../../manuals/p2-xbyte-programming-guide/opus-master"
OUTPUT="P2-XBYTE-Programming-Guide.md"

echo "========================================"
echo "P2 XBYTE Programming Guide Assembly"
echo "========================================"
echo ""
