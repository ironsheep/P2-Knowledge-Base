#!/bin/bash
# Getting Started with the Propeller 2 — Assembly Script
...
OPUS_MASTER="../../manuals/p2-getting-started-guide/opus-master"
OUTPUT="P2-Getting-Started-Guide.md"

echo "========================================"
echo "Getting Started with the Propeller 2 — Assembly"
echo "========================================"
echo ""
