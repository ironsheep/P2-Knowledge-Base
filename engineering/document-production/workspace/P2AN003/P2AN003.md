...
| 0.1.0 | 2026-06-30 | First draft. All code compiles clean under `pnut_ts` (`-d` where it uses `debug()`); audio-quality figures (SNR/THD/effective bits) qualitative pending hardware characterization. |
