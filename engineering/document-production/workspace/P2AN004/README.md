# Workspace — P2AN004 (Application Note)

Production-preparation workspace for the **P2AN004** application note. This is the
...
```
app-notes/P2AN004/opus-master/   ← CONTENT AUTHORING (front-matter.md + P2AN004.md)   authoritative
workspace/P2AN004/               ← PRODUCTION PREPARATION (this folder)
outbound/P2AN004/                ← STAGING FOR PDF FORGE
```

## Canonical name

`P2AN004` — used identically for the workspace folder, the outbound folder, the
...
| File | Purpose |
|------|---------|
| `assemble-manual.sh` | Concatenates `front-matter.md` (cover) + `P2AN004.md` (body) from the app-note opus-master into `P2AN004.md` here. |
| `P2AN004.md` | The assembled working copy (generated — do not edit; edit opus-master). |
...
```
./assemble-manual.sh
../../../tools/conversion/latex-escape-all.sh P2AN004.md      # or via prepare-manual
# stage changed files to ../../outbound/P2AN004/ ; user moves outbound -> Forge
```
