...
ordering signal; `todo_next` walks it. Total estimate **35h 15m** across 14 tasks.

| Plan § | Deliverable | Task | seq | est |
|---|---|---|---|---|
| §10a | Close the fidelity tool's heading-form harvest gap | «#292» | 1 | 45m |
| §4 (1/2) | Purge unsourced blocks — `architecture` · `language` · `guides` · `application-notes` (65) | «#293» | 2 | 4h |
| §4 (2/2) | Purge or ground unsourced blocks — `hardware/` (48) | «#294» | 3 | 3h |
| §6 | Define the 41 constants; one definition home **(two-phase)** | «#295» | 4 | 3h |
| §5 | Correct the drive-strength mislabel class by deletion + repoint | «#296» | 5 | 2h 30m |
| §8 (1/2) | Extract the datasheet electrical tables; move the five dashboards | «#297» | 6 | 3h |
| §7 | Whole-KB promotion filter — three dispositions per block | «#298» | 7 | 3h |
| §8 (2/2) | Restore only what verifies **and** belongs, each cited | «#299» | 8 | 1h 30m |
| §9 (1/3) | Drain the KB/ingestion pre-existing findings; verify F-218 first | «#300» | 9 | 3h |
| §9 (2/3) | Drain the manual/app-note-prose pre-existing findings | «#301» | 10 | 5h |
| §11 | Give the KB a release-notes home; resolve both routing `TBD`s | «#303» | 11 | 1h |
| Blast radius | The mandatory documentation task | «#304» | 12 | 1h 30m |
| §10b | Arm both gates — blocking, no baseline | «#305» | 13 | 1h |
| §9 (3/3) | Render-gated findings + the all-51 status reconciliation | «#302» | 14 | 3h |
