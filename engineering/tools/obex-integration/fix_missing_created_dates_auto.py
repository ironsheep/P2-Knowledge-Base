#!/usr/bin/env python3
"""
Fix missing created_date fields by extracting from OBEX pages (non-interactive version)
"""
...
def main():
    ...
    print("MISSING CREATED DATE EXTRACTION FIX (AUTO)")
    print("=" * 70)
    ...
    if missing:
        ...
        print(f"\nProceeding automatically with extraction from {len(missing)} OBEX pages (~{len(missing) * 1.5:.0f} minutes)...")
