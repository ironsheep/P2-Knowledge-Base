...
### F-204 — `rdpin.yaml` RDPIN IN-flag-reset snippet shows **two** NOPs for a **2-clock** delay (one NOP = 2 clocks, so it over-waits) — `GROUNDED → apply one-NOP YAML fix` (was NEEDS-VERIFICATION; grounding closed 2026-07-10)
