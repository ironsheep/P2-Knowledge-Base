...
> `%0000` is the disassembler edge case: with no `WC`/`WZ` it is the `_RET_`
> form (always-execute + return); the assembler shows the bare prefix as
> `IF_NEVER` only when flags are written. `%1111` is the default (always), printed
> with no `IF_` prefix.
...
| **CALLA** | `EEEE 1101011 CZ0 DDDDDDDDD 000101110`<br>`EEEE 1101110 RAA AAAAAAAAA AAAAAAAAA` | #S \| D | C,Z | 5-12 | Call a subroutine; store return context in the Hub long at PTRA++ or PTRB++ |
| **CALLB** | `EEEE 1101011 CZ0 DDDDDDDDD 000101111`<br>`EEEE 1101111 RAA AAAAAAAAA AAAAAAAAA` | #S \| D | C,Z | 5-12 | Call a subroutine; store return context in the Hub long at PTRB++ |
...
| **CALLPA** | `EEEE 1011010 0LI DDDDDDDDD SSSSSSSSS` | D/#,S/@ | C,Z | 4 | Call a subroutine; store return context on the stack and copy D into PA or PB |
| **CALLPB** | `EEEE 1011010 1LI DDDDDDDDD SSSSSSSSS` | D/#,S/@ | C,Z | 4 | Call a subroutine; store return context on the stack and copy D into PA or PB |
| **DJF** | `EEEE 1011011 10I DDDDDDDDD SSSSSSSSS` | D,S/@ | C,Z | 2 | Decrement value and jump if full (-1; $FFFF_FFFF) or not full (<> -1; <> $FFFF_FFFF) |
| **DJNF** | `EEEE 1011011 11I DDDDDDDDD SSSSSSSSS` | D,S/@ | C,Z | 2 | Decrement value and jump if full (-1; $FFFF_FFFF) or not full (<> -1; <> $FFFF_FFFF) |
| **DJNZ** | `EEEE 1011011 01I DDDDDDDDD SSSSSSSSS` | D,S/@ | C,Z | 2 | Decrement, jump if zero or not zero |
| **DJZ** | `EEEE 1011011 00I DDDDDDDDD SSSSSSSSS` | D,S/@ | C,Z | 2 | Decrement, jump if zero or not zero |
| **EXECF** | `EEEE 1101011 00L DDDDDDDDD 000110011` | D/#0..511 | C,Z | 4/4 | Call+Skip |
| **IJNZ** | `EEEE 1011100 01I DDDDDDDDD SSSSSSSSS` | D,S/@ | C,Z | 2 | Increment value and jump if zero or not zero |
| **IJZ** | `EEEE 1011100 00I DDDDDDDDD SSSSSSSSS` | D,S/@ | C,Z | 2 | Increment value and jump if zero or not zero |
| **JMP** | `EEEE 1101011 CZ0 DDDDDDDDD 000101100`<br>`EEEE 1101100 RAA AAAAAAAAA AAAAAAAAA` | #S \| D | C,Z | 4 | Jump |
| **JMPREL** | `EEEE 1101011 00L DDDDDDDDD 000110000` | D/#0..511 | C,Z | 4 | Jump ahead/back by D instructions |
| **REP** | `EEEE 1100110 1LI DDDDDDDDD SSSSSSSSS` | @,S/# \| D/#,S/# | C,Z | 2/2 | Execute next D[8:0] instructions S times |
| **RESI0** | `EEEE 1011001 110 111111110 111111111` | operand_xlat | C,Z | 4 | Resume from interrupt 0 |
| **RESI1** | `EEEE 1011001 110 111110100 111110101` | operand_xlat | C,Z | 4 | Resume from interrupt 1 |
| **RESI2** | `EEEE 1011001 110 111110010 111110011` | operand_xlat | C,Z | 4 | Resume from interrupt 2 |
| **RESI3** | `EEEE 1011001 110 111110000 111110001` | operand_xlat | C,Z | 4 | Resume from interrupt 3 |
...
| **RETI0** | `EEEE 1011001 110 111111111 111111111` | operand_xlat | C,Z | 4 | Return from interrupt 0 |
| **RETI1** | `EEEE 1011001 110 111111111 111110101` | operand_xlat | C,Z | 4 | Return from interrupt 1 |
| **RETI2** | `EEEE 1011001 110 111111111 111110011` | operand_xlat | C,Z | 4 | Return from interrupt 2 |
| **RETI3** | `EEEE 1011001 110 111111111 111110001` | operand_xlat | C,Z | 4 | Return from interrupt 3 |
| **SKIP** | `EEEE 1101011 00L DDDDDDDDD 000110001` | D/#0..511 | C,Z | 2 | Skip next instructions based on D bitmask |
| **SKIPF** | `EEEE 1101011 00L DDDDDDDDD 000110010` | D/#0..511 | C,Z | 2 | Fast skip - jump over instructions based on D bitmask |
| **TJF** | `EEEE 1011101 00I DDDDDDDDD SSSSSSSSS` | D,S/@ | C,Z | 2 | Test value and jump if full ($FFFFFFFF) |
| **TJNF** | `EEEE 1011101 01I DDDDDDDDD SSSSSSSSS` | D,S/@ | C,Z | 2 | Test value and jump if not full (<> $FFFF_FFFF) |
| **TJNS** | `EEEE 1011101 11I DDDDDDDDD SSSSSSSSS` | D,S/@ | C,Z | 2 | Test value and jump if not signed (positive) |
| **TJNZ** | `EEEE 1011100 11I DDDDDDDDD SSSSSSSSS` | D,S/@ | C,Z | 2 | Test value and jump if zero or not zero |
| **TJS** | `EEEE 1011101 10I DDDDDDDDD SSSSSSSSS` | D,S/@ | C,Z | 2 | Test value and jump if signed (D[31] = 1) |
| **TJV** | `EEEE 1011110 00I DDDDDDDDD SSSSSSSSS` | D,S/@ | C,Z | 2 not-taken / 4 taken (cog); 2 not-taken / 13-20 taken (hub-exec) | Test value and jump if overflowed |
| **TJZ** | `EEEE 1011100 10I DDDDDDDDD SSSSSSSSS` | D,S/@ | C,Z | 2 | Test value and jump if zero |
...
| **QDIV** | `EEEE 1101000 1LI DDDDDDDDD SSSSSSSSS` | D/#,S/# | C,Z | 2 | Perform 64÷32 unsigned division with 32-bit quotient and remainder |
| **QEXP** | `EEEE 1101011 00L DDDDDDDDD 000001111` | D/#0..511 | C,Z | 2 | Convert 5:27-bit logarithm to 32-bit unsigned integer |
| **QFRAC** | `EEEE 1101001 0LI DDDDDDDDD SSSSSSSSS` | D/#,S/# | C,Z | 2 | Perform 64÷32 unsigned fractional division with D as upper 32 bits |
| **QLOG** | `EEEE 1101011 00L DDDDDDDDD 000001110` | D/#0..511 | C,Z | 2 | Convert 32-bit unsigned integer to 5:27-bit logarithm format |
| **QMUL** | `EEEE 1101000 0LI DDDDDDDDD SSSSSSSSS` | D/#,S/# | C,Z | 2 | Perform 32×32 unsigned multiplication producing 64-bit result |
| **QROTATE** | `EEEE 1101010 0LI DDDDDDDDD SSSSSSSSS` | D/#,S/# | C,Z | 2 | Rotate a 32-bit signed (X, Y) point around origin (0, 0) by a specified angle |
| **QSQRT** | `EEEE 1101001 1LI DDDDDDDDD SSSSSSSSS` | D/#,S/# | C,Z | 2 | Calculate square root of 64-bit unsigned number formed from {S, D} |
| **QVECTOR** | `EEEE 1101010 1LI DDDDDDDDD SSSSSSSSS` | D/#,S/# | C,Z | 2 | Convert cartesian coordinates (X, Y) to polar coordinates (length, angle) |

## Color Space Converter  (5)

| Mnemonic | Encoding | Operands | Flags | Cyc | Summary |
|----------|----------|----------|-------|-----|---------|
| **SETCFRQ** | `EEEE 1101011 00L DDDDDDDDD 000111011` | D/#0..511 | C,Z | 2 | Set the colorspace converter \"CFRQ\" parameter to D[31:0] |
| **SETCI** | `EEEE 1101011 00L DDDDDDDDD 000111001` | D/#0..511 | C,Z | 2 | Set the colorspace converter \"CI\" parameter to D[31:0] |
| **SETCMOD** | `EEEE 1101011 00L DDDDDDDDD 000111100` | D/#0..511 | C,Z | 2 | Set the colorspace converter \"CMOD\" parameter to D[8:0] |
| **SETCQ** | `EEEE 1101011 00L DDDDDDDDD 000111010` | D/#0..511 | C,Z | 2 | Set the colorspace converter \"CQ\" parameter to D[31:0] |
| **SETCY** | `EEEE 1101011 00L DDDDDDDDD 000111000` | D/#0..511 | C,Z | 2 | Set the colorspace converter \"CY\" parameter to D[31:0] |
...
| Mnemonic | Encoding | Operands | Flags | Cyc | Summary |
|----------|----------|----------|-------|-----|---------|
| **ADDCT1** | `EEEE 1010011 00I DDDDDDDDD SSSSSSSSS` | D,S/# | C,Z | 2 | Set CT1 counter event trigger time |
| **ADDCT2** | `EEEE 1010011 01I DDDDDDDDD SSSSSSSSS` | D,S/# | C,Z | 2 | Set CT2 counter event trigger time |
| **ADDCT3** | `EEEE 1010011 10I DDDDDDDDD SSSSSSSSS` | D,S/# | C,Z | 2 | Set CT3 counter event trigger time |
| **COGATN** | `EEEE 1101011 00L DDDDDDDDD 000111111` | D/#0..511 | C,Z | 2 | Get the attention of one or more other cogs |
| **JATN** | `EEEE 1011110 01I 000001110 SSSSSSSSS` | S/# | C,Z | 2 | Jump if ATN event flag is set |
| **JCT1** | `EEEE 1011110 01I 000000001 SSSSSSSSS` | S/# | C,Z | 2 | Jump if counter 1 event flag is set |
| **JCT2** | `EEEE 1011110 01I 000000010 SSSSSSSSS` | S/# | C,Z | 2 | Jump if counter 2 event flag is set |
| **JCT3** | `EEEE 1011110 01I 000000011 SSSSSSSSS` | S/# | C,Z | 2 | Jump if counter 3 event flag is set |
| **JFBW** | `EEEE 1011110 01I 000001001 SSSSSSSSS` | S/# | C,Z | 2 | Jump if FIFO interface block wrap event flag is set or clear |
| **JINT** | `EEEE 1011110 01I 000000000 SSSSSSSSS` | S/# | C,Z | 2 | Jump if INT event flag is set |
| **JNATN** | `EEEE 1011110 01I 000011110 SSSSSSSSS` | S/# | C,Z | 2 | Jump if ATN event flag is clear |
| **JNCT1** | `EEEE 1011110 01I 000010001 SSSSSSSSS` | S/# | C,Z | 2 | Branch |
| **JNCT2** | `EEEE 1011110 01I 000010010 SSSSSSSSS` | S/# | C,Z | 2 | Branch |
| **JNCT3** | `EEEE 1011110 01I 000010011 SSSSSSSSS` | S/# | C,Z | 2 | Branch |
| **JNFBW** | `EEEE 1011110 01I 000011001 SSSSSSSSS` | S/# | C,Z | 2 | Jump if FIFO interface block wrap event flag is set or clear |
| **JNINT** | `EEEE 1011110 01I 000010000 SSSSSSSSS` | S/# | C,Z | 2 | Branch |
| **JNPAT** | `EEEE 1011110 01I 000011000 SSSSSSSSS` | S/# | C,Z | 2 | Branch |
| **JNQMT** | `EEEE 1011110 01I 000011111 SSSSSSSSS` | S/# | C,Z | 2 | Jump if CORDIC-read-but-empty event flag set or clear |
| **JNSE1** | `EEEE 1011110 01I 000010100 SSSSSSSSS` | S/# | C,Z | 2 | Branch |
| **JNSE2** | `EEEE 1011110 01I 000010101 SSSSSSSSS` | S/# | C,Z | 2 | Branch |
| **JNSE3** | `EEEE 1011110 01I 000010110 SSSSSSSSS` | S/# | C,Z | 2 | Branch |
| **JNSE4** | `EEEE 1011110 01I 000010111 SSSSSSSSS` | S/# | C,Z | 2 | Branch |
| **JNXFI** | `EEEE 1011110 01I 000011011 SSSSSSSSS` | S/# | C,Z | 2 | Branch |
| **JNXMT** | `EEEE 1011110 01I 000011010 SSSSSSSSS` | S/# | C,Z | 2 | Jump if streamer empty event flag set or clear |
| **JNXRL** | `EEEE 1011110 01I 000011101 SSSSSSSSS` | S/# | C,Z | 2 | Jump if streamer LUT RAM rollover event flag set or clear |
| **JNXRO** | `EEEE 1011110 01I 000011100 SSSSSSSSS` | S/# | C,Z | 2 | Branch |
| **JPAT** | `EEEE 1011110 01I 000001000 SSSSSSSSS` | S/# | C,Z | 2 | Branch |
| **JQMT** | `EEEE 1011110 01I 000001111 SSSSSSSSS` | S/# | C,Z | 2 | Jump if CORDIC-read-but-empty event flag set or clear |
| **JSE1** | `EEEE 1011110 01I 000000100 SSSSSSSSS` | S/# | C,Z | 2 | Branch |
| **JSE2** | `EEEE 1011110 01I 000000101 SSSSSSSSS` | S/# | C,Z | 2 | Branch |
| **JSE3** | `EEEE 1011110 01I 000000110 SSSSSSSSS` | S/# | C,Z | 2 | Branch |
| **JSE4** | `EEEE 1011110 01I 000000111 SSSSSSSSS` | S/# | C,Z | 2 | Branch |
| **JXFI** | `EEEE 1011110 01I 000001011 SSSSSSSSS` | S/# | C,Z | 2 | Branch |
| **JXMT** | `EEEE 1011110 01I 000001010 SSSSSSSSS` | S/# | C,Z | 2 | Jump if streamer empty event flag set or clear |
| **JXRL** | `EEEE 1011110 01I 000001101 SSSSSSSSS` | S/# | C,Z | 2 | Jump if streamer LUT RAM rollover event flag set or clear |
| **JXRO** | `EEEE 1011110 01I 000001100 SSSSSSSSS` | S/# | C,Z | 2 | Branch |
...
| **SETPAT** | `EEEE 1011111 1LI DDDDDDDDD SSSSSSSSS` | D/#,S/# | C,Z | 2 | Set pin pattern for PAT event detection |
| **SETSE1** | `EEEE 1101011 00L DDDDDDDDD 000100000` | D/#0..511 | C,Z | 2 | Configure selectable event 1 for pin/LUT/lock triggers |
| **SETSE2** | `EEEE 1101011 00L DDDDDDDDD 000100001` | D/#0..511 | C,Z | 2 | Configure selectable event 2 for pin/LUT/lock triggers |
| **SETSE3** | `EEEE 1101011 00L DDDDDDDDD 000100010` | D/#0..511 | C,Z | 2 | Configure selectable event 3 for pin/LUT/lock triggers |
| **SETSE4** | `EEEE 1101011 00L DDDDDDDDD 000100011` | D/#0..511 | C,Z | 2 | Configure selectable event 4 for pin/LUT/lock triggers |
...
| Mnemonic | Encoding | Operands | Flags | Cyc | Summary |
|----------|----------|----------|-------|-----|---------|
| **COGID** | `EEEE 1101011 C0L DDDDDDDDD 000000001` | D/#0..511 | C,Z | 2 | Get current cog's ID or any cog's status by ID |
| **COGINIT** | `EEEE 1100111 CLI DDDDDDDDD SSSSSSSSS` | D/#,S/# | C,Z | 2 | Start an available cog, or restart a cog by ID |
| **COGSTOP** | `EEEE 1101011 00L DDDDDDDDD 000000011` | D/#0..511 | C,Z | 2 | Stop a cog by ID |
| **HUBSET** | `EEEE 1101011 00L DDDDDDDDD 000000000` | D/#0..511 | C,Z | 2 | Set hub configuration |
| **LOCKNEW** | `EEEE 1101011 C00 DDDDDDDDD 000000100` | D | C,Z | 4 | Request a new LOCK |
| **LOCKREL** | `EEEE 1101011 C0L DDDDDDDDD 000000111` | D/#0..511 | C,Z | 2 | Release LOCK |
| **LOCKRET** | `EEEE 1101011 00L DDDDDDDDD 000000101` | D/#0..511 | C,Z | 2 | Return LOCK for reallocation |
| **LOCKTRY** | `EEEE 1101011 C0L DDDDDDDDD 000000110` | D/#0..511 | C,Z | 2 | Try to acquire lock |

## Hub FIFO  (12)

| Mnemonic | Encoding | Operands | Flags | Cyc | Summary |
|----------|----------|----------|-------|-----|---------|
| **FBLOCK** | `EEEE 1100100 1LI DDDDDDDDD SSSSSSSSS` | D/#,S/# | C,Z | 2 | New Block |
| **GETPTR** | `EEEE 1101011 000 DDDDDDDDD 000110100` | D | C,Z | 2 | Get current FIFO hub pointer into D |
| **RDFAST** | `EEEE 1100011 1LI DDDDDDDDD SSSSSSSSS` | D/#,S/# | C,Z | 2 | Begin new fast hub read via FIFO |
...
| **WFBYTE** | `EEEE 1101011 00L DDDDDDDDD 000010101` | D/#0..511 | C,Z | 2 | Write byte to FIFO |
| **WFLONG** | `EEEE 1101011 00L DDDDDDDDD 000010111` | D/#0..511 | C,Z | 2 | Write long to FIFO |
| **WFWORD** | `EEEE 1101011 00L DDDDDDDDD 000010110` | D/#0..511 | C,Z | 2 | Write word to FIFO |
| **WRFAST** | `EEEE 1100100 0LI DDDDDDDDD SSSSSSSSS` | D/#,S/# | C,Z | 2 | Begin new fast hub write via FIFO |
...
| **PUSHA** | `EEEE 1100011 0L1 DDDDDDDDD 101100001` | D/# \| D | C,Z | 3...10 (cog) / 3...20 (hub-exec) | Push long to hub stack using PTRA (post-increment) |
| **PUSHB** | `EEEE 1100011 0L1 DDDDDDDDD 111100001` | D/# \| D | C,Z | 3...10 (cog) / 3...20 (hub-exec) | Push long to hub stack using PTRB (post-increment) |
...
| **WMLONG** | `EEEE 1010011 11I DDDDDDDDD SSSSSSSSS` |  | C,Z | 3 | Write masked long to hub RAM (non-zero bytes only) |
| **WRBYTE** | `EEEE 1100010 0LI DDDDDDDDD SSSSSSSSS` | D/#,S/#/PTRA/PTRB | C,Z | 3 | Write byte to hub RAM |
| **WRLONG** | `EEEE 1100011 0LI DDDDDDDDD SSSSSSSSS` | D/#,S/#/PTRA/PTRB | C,Z | 3...10 (cog) / 3...20 (hub-exec) | Write long to hub RAM |
| **WRWORD** | `EEEE 1100010 1LI DDDDDDDDD SSSSSSSSS` | D/#,S/#/PTRA/PTRB | C,Z | 3...10 (cog) / 3...20 (hub-exec) | Write word to hub RAM |

## Interrupt  (14)

| Mnemonic | Encoding | Operands | Flags | Cyc | Summary |
|----------|----------|----------|-------|-----|---------|
| **ALLOWI** | `EEEE 1101011 000 000100000 000100100` | operand_pollwait | C,Z | 2 | Allow interrupts |
| **BRK** | `EEEE 1101011 00L DDDDDDDDD 000110110` | D/#0..511 | C,Z | 2 | Trigger breakpoint in current cog |
| **COGBRK** | `EEEE 1101011 00L DDDDDDDDD 000110101` | D/#0..511 | C,Z | 2 | Trigger breakpoint in specified cog |
| **GETBRK** | `EEEE 1101011 CZ0 DDDDDDDDD 000110101` | D/# WC/WZ/WCZ | C,Z | 2 | Get breakpoint/cog status into D according to WC/WZ/WCZ |
| **NIXINT1** | `EEEE 1101011 000 000100101 000100100` | operand_pollwait | C,Z | 2 | Cancel INT1 |
| **NIXINT2** | `EEEE 1101011 000 000100110 000100100` | operand_pollwait | C,Z | 2 | Cancel INT2 |
| **NIXINT3** | `EEEE 1101011 000 000100111 000100100` | operand_pollwait | C,Z | 2 | Cancel INT3 |
| **SETINT1** | `EEEE 1101011 00L DDDDDDDDD 000100101` | D/#0..511 | C,Z | 2 | Set INT1 source to D[3:0] |
| **SETINT2** | `EEEE 1101011 00L DDDDDDDDD 000100110` | D/#0..511 | C,Z | 2 | Set INT2 source to D[3:0] |
| **SETINT3** | `EEEE 1101011 00L DDDDDDDDD 000100111` | D/#0..511 | C,Z | 2 | Set INT3 source to D[3:0] |
| **STALLI** | `EEEE 1101011 000 000100001 000100100` | operand_pollwait | C,Z | 2 | Prevent further interrupts |
| **TRGINT1** | `EEEE 1101011 000 000100010 000100100` | operand_pollwait | C,Z | 2 | Trigger INT1, regardless of STALLI mode |
| **TRGINT2** | `EEEE 1101011 000 000100011 000100100` | operand_pollwait | C,Z | 2 | Trigger INT2, regardless of STALLI mode |
| **TRGINT3** | `EEEE 1101011 000 000100100 000100100` | operand_pollwait | C,Z | 2 | Trigger INT3, regardless of STALLI mode |
...
| **SETLUTS** | `EEEE 1101011 00L DDDDDDDDD 000110111` | D/#0..511 | C,Z | 2 | If D[0] = 1 then enable LUT sharing |
| **WRLUT** | `EEEE 1100001 1LI DDDDDDDDD SSSSSSSSS` | D/#,S/#/PTRA/PTRB | C,Z | 2 | Write D to LUT address {#}S/PTRx |
...
| **BMASK** | `EEEE 1001110 01I DDDDDDDDD SSSSSSSSS`<br>`EEEE 1001110 010 DDDDDDDDD DDDDDDDDD` | D{,S/#} | C,Z | 2 | Get 1..32-bit mask into Dest |
...
| **CRCBIT** | `EEEE 1001110 10I DDDDDDDDD SSSSSSSSS` | D,S/# | C,Z | 2 | Iterate CRC value in D using C and polynomial in S |
| **CRCNIB** | `EEEE 1001110 11I DDDDDDDDD SSSSSSSSS` | D,S/# | C,Z | 2 | Q = Q << 4 |
| **DECMOD** | `EEEE 0111001 CZI DDDDDDDDD SSSSSSSSS` | D,S/# | C,Z | 2 | Decrement with modulus |
| **DECOD** | `EEEE 1001110 00I DDDDDDDDD SSSSSSSSS`<br>`EEEE 1001110 000 DDDDDDDDD DDDDDDDDD` | D{,S/#} | C,Z | 2 | Decode value (0-31) into single-high-bit long |
...
| **GETBYTE** | `EEEE 1000111 NNI DDDDDDDDD SSSSSSSSS`<br>`EEEE 1000111 000 DDDDDDDDD 000000000` | D{,S/#,#0..3} | C,Z | 2 | Get a byte from a value |
| **GETNIB** | `EEEE 100001N NNI DDDDDDDDD SSSSSSSSS`<br>`EEEE 1000010 000 DDDDDDDDD 000000000` | D{,S/#,#0..7} | C,Z | 2 | Get a nibble from a value |
| **GETWORD** | `EEEE 1001001 1NI DDDDDDDDD SSSSSSSSS`<br>`EEEE 1001001 100 DDDDDDDDD 000000000` | D{,S/#,#0..1} | C,Z | 2 | Get a word from a value |
| **INCMOD** | `EEEE 0111000 CZI DDDDDDDDD SSSSSSSSS` | D,S/# | C,Z | 2 | Increment with modulus |
| **LOC** | `EEEE 11101WW RAA AAAAAAAAA AAAAAAAAA` | D,#S{\} | C,Z | 2 | Load address into PA/PB/PTRA/PTRB |
| **MERGEB** | `EEEE 1101011 000 DDDDDDDDD 001100001` | D | C,Z | 2 | Merge bits of bytes in D |
| **MERGEW** | `EEEE 1101011 000 DDDDDDDDD 001100011` | D | C,Z | 2 | Merge bits of words in D |
| **MODC** | `EEEE 1101011 C01 0cccc0000 001101111` | #C{,#Z} | C,Z | 2 | Modify C and/or Z flag(s) according to modifier mode and current state(s) |
...
| **MODZ** | `EEEE 1101011 0Z1 00000zzzz 001101111` | #C{,#Z} | C,Z | 2 | Modify C and/or Z flag(s) according to modifier mode and current state(s) |
| **MOV** | `EEEE 0110000 CZI DDDDDDDDD SSSSSSSSS` | D,S/# | C,Z | 2 | Set a value into a register |
| **MOVBYTS** | `EEEE 1001111 11I DDDDDDDDD SSSSSSSSS` | D,S/# | C,Z | 2 | Move bytes within D, per S |
| **MUL** | `EEEE 1010000 0ZI DDDDDDDDD SSSSSSSSS` | D,S/# | C,Z | 2 | Multiply unsigned 16-bit x 16-bit values |
| **MULS** | `EEEE 1010000 1ZI DDDDDDDDD SSSSSSSSS` | D,S/# | C,Z | 2 | Multiply signed 16-bit x 16-bit values |
...
| **MUXNIBS** | `EEEE 1001111 01I DDDDDDDDD SSSSSSSSS` | D,S/# | C,Z | 2 | Set discrete nibbles of a value to non-zero nibble states of another |
| **MUXNITS** | `EEEE 1001111 00I DDDDDDDDD SSSSSSSSS` | D,S/# | C,Z | 2 | Set discrete bit pairs of a value to non-zero bit pair states of another |
| **MUXNZ** | `EEEE 0101111 CZI DDDDDDDDD SSSSSSSSS` | D,S/# | C,Z | 2 | Set discrete bits to Z or !Z |
| **MUXQ** | `EEEE 1001111 10I DDDDDDDDD SSSSSSSSS` | D,S/# | C,Z | 2 | Set discrete bits of a value to that of another |
...
| **REV** | `EEEE 1101011 000 DDDDDDDDD 001101001` | D | C,Z | 2 | Reverse bits of value |
| **RGBEXP** | `EEEE 1101011 000 DDDDDDDDD 001100111` | D | C,Z | 2 | Expand 5:6:5 RGB value in D[15:0] into 8:8:8 value in D[31:8] |
| **RGBSQZ** | `EEEE 1101011 000 DDDDDDDDD 001100110` | D | C,Z | 2 | Squeeze 8:8:8 RGB value in D[31:8] into 5:6:5 value in D[15:0] |
| **ROL** | `EEEE 0000001 CZI DDDDDDDDD SSSSSSSSS` | D,S/# | C,Z | 2 | Rotate bits left |
| **ROLBYTE** | `EEEE 1001000 NNI DDDDDDDDD SSSSSSSSS`<br>`EEEE 1001000 000 DDDDDDDDD 000000000` | D{,S/#,#0..3} | C,Z | 2 | Rotate a byte left into a value |
| **ROLNIB** | `EEEE 100010N NNI DDDDDDDDD SSSSSSSSS`<br>`EEEE 1000100 000 DDDDDDDDD 000000000` | D{,S/#,#0..7} | C,Z | 2 | Rotate a nibble left into a value |
| **ROLWORD** | `EEEE 1001010 0NI DDDDDDDDD SSSSSSSSS`<br>`EEEE 1001010 000 DDDDDDDDD 000000000` | D{,S/#,#0..1} | C,Z | 2 | Rotate a word left into a value |
...
| **SCA** | `EEEE 1010001 0ZI DDDDDDDDD SSSSSSSSS` | D,S/# | C,Z | 2 | Create unsigned 16-bit scale value for next instruction's S value |
| **SCAS** | `EEEE 1010001 1ZI DDDDDDDDD SSSSSSSSS` | D,S/# | C,Z | 2 | Create signed 18-bit scale value for next instruction's S value |
| **SETBYTE** | `EEEE 1000110 NNI DDDDDDDDD SSSSSSSSS`<br>`EEEE 1000110 00I 000000000 SSSSSSSSS` | S/#{,D,#0..3} | C,Z | 2 | Set a byte to new value |
| **SETD** | `EEEE 1001101 10I DDDDDDDDD SSSSSSSSS` | D,S/# | C,Z | 2 | Set template D field for ALTI |
| **SETNIB** | `EEEE 100000N NNI DDDDDDDDD SSSSSSSSS`<br>`EEEE 1000000 00I 000000000 SSSSSSSSS` | S/#{,D,#0..7} | C,Z | 2 | Set a nibble to new value |
| **SETR** | `EEEE 1001101 01I DDDDDDDDD SSSSSSSSS` | D,S/# | C,Z | 2 | Set template Result field for ALTI |
| **SETS** | `EEEE 1001101 11I DDDDDDDDD SSSSSSSSS` | D,S/# | C,Z | 2 | Set template S field for ALTI |
| **SETWORD** | `EEEE 1001001 0NI DDDDDDDDD SSSSSSSSS`<br>`EEEE 1001001 00I 000000000 SSSSSSSSS` | S/#{,D,#0..1} | C,Z | 2 | Set a word to new value |
| **SEUSSF** | `EEEE 1101011 000 DDDDDDDDD 001100100` | D | C,Z | 2 | Relocate and periodically invert bits within D |
| **SEUSSR** | `EEEE 1101011 000 DDDDDDDDD 001100101` | D | C,Z | 2 | Relocate and periodically invert bits within D |
...
| **SPLITB** | `EEEE 1101011 000 DDDDDDDDD 001100000` | D | C,Z | 2 | Split every 4th bit of D into bytes |
| **SPLITW** | `EEEE 1101011 000 DDDDDDDDD 001100010` | D | C,Z | 2 | Split odd/even bits of D into words |
...
| **WRC** | `EEEE 1101011 000 DDDDDDDDD 001101100` | D | C,Z | 2 | Write 0 or 1 to D, according to C |
| **WRNC** | `EEEE 1101011 000 DDDDDDDDD 001101101` | D | C,Z | 2 | Write C or not C to register |
| **WRNZ** | `EEEE 1101011 000 DDDDDDDDD 001101111` | D | C,Z | 2 | Write Z or not Z to register |
| **WRZ** | `EEEE 1101011 000 DDDDDDDDD 001101110` | D | C,Z | 2 | Write 0 or 1 to D, according to Z |
| **XOR** | `EEEE 0101011 CZI DDDDDDDDD SSSSSSSSS` | D,S/# | C,Z | 2 | Bitwise XOR a value with another |
| **XORO32** | `EEEE 1101011 000 DDDDDDDDD 001101000` | D | C,Z | 2 | Iterate D with xoroshiro32+ PRNG algorithm (requires non-zero seed) |
...
| Mnemonic | Encoding | Operands | Flags | Cyc | Summary |
|----------|----------|----------|-------|-----|---------|
| **AUGD** | `EEEE 11111DD DDD DDDDDDDDD DDDDDDDDD` | #S | C,Z | 2 | Augment next literal Dest to 32-bits |
| **AUGS** | `EEEE 11110SS SSS SSSSSSSSS SSSSSSSSS` | #S | C,Z | 2 | Augment next literal Src to 32-bits |
| **GETCT** | `EEEE 1101011 C00 DDDDDDDDD 000011010` | D | C,Z | 2 | T=0 on reset, CT++ on every clock |
| **GETRND** | `EEEE 1101011 CZ0 DDDDDDDDD 000011011`<br>`EEEE 1101011 CZ1 000000000 000011011` | D \| {WC/WZ/WCZ} | C,Z | 2 | Get RND into C/Z |
| **NOP** | `0000 0000000 000 000000000 000000000` | operand_nop | C,Z | 2 | No operation, just elapse two cycles |
| **POP** | `EEEE 1101011 CZ0 DDDDDDDDD 000101011` | D | C,Z | 2 | Pop internal stack (K) to destination register |
| **PUSH** | `EEEE 1101011 00L DDDDDDDDD 000101010` | D/#0..511 | C,Z | 2 | Push value onto internal stack (K) |
| **SETQ** | `EEEE 1101011 00L DDDDDDDDD 000101000` | D/#0..511 | C,Z | 2 | Set Q to D |
| **SETQ2** | `EEEE 1101011 00L DDDDDDDDD 000101001` | D/#0..511 | C,Z | 2 | Set Q to D |
...
| Mnemonic | Encoding | Operands | Flags | Cyc | Summary |
|----------|----------|----------|-------|-----|---------|
| **ADDPIX** | `EEEE 1010010 00I DDDDDDDDD SSSSSSSSS` | D,S/# | C,Z | 7 | Add RGB colors with full saturation |
| **BLNPIX** | `EEEE 1010010 10I DDDDDDDDD SSSSSSSSS` | D,S/# | C,Z | 7 | Alpha-blend bytes of S into bytes of D, using SETPIV value |
| **MIXPIX** | `EEEE 1010010 11I DDDDDDDDD SSSSSSSSS` | D,S/# | C,Z | 7 | Mix bytes of S into bytes of D, using SETPIX and SETPIV values |
| **MULPIX** | `EEEE 1010010 01I DDDDDDDDD SSSSSSSSS` | D,S/# | C,Z | 7 | Multiply bytes of S into bytes of D, where $FF = 1 |
| **SETPIV** | `EEEE 1101011 00L DDDDDDDDD 000111101` | D/#0..511 | C,Z | 2 | Set BLNPIX/MIXPIX blend factor to D[7:0] |
| **SETPIX** | `EEEE 1101011 00L DDDDDDDDD 000111110` | D/#0..511 | C,Z | 2 | Set MIXPIX mode to D[5:0] |

## Register Indirection  (11)

| Mnemonic | Encoding | Operands | Flags | Cyc | Summary |
|----------|----------|----------|-------|-----|---------|
| **ALTB** | `EEEE 1001100 11I DDDDDDDDD SSSSSSSSS`<br>`EEEE 1001100 111 DDDDDDDDD 000000000` | D{,S/#} | C,Z | 2 | Alter subsequent BITxxx instruction |
| **ALTD** | `EEEE 1001100 01I DDDDDDDDD SSSSSSSSS`<br>`EEEE 1001100 011 DDDDDDDDD 000000000` | D{,S/#} | C,Z | 2 | Alter D field of next instruction |
| **ALTGB** | `EEEE 1001011 01I DDDDDDDDD SSSSSSSSS`<br>`EEEE 1001011 011 DDDDDDDDD 000000000` | D{,S/#} | C,Z | 2 | Alter subsequent GETBYTE / ROLBYTE instruction |
| **ALTGN** | `EEEE 1001010 11I DDDDDDDDD SSSSSSSSS`<br>`EEEE 1001010 111 DDDDDDDDD 000000000` | D{,S/#} | C,Z | 2 | Alter subsequent GETNIB / ROLNIB instruction |
| **ALTGW** | `EEEE 1001011 11I DDDDDDDDD SSSSSSSSS`<br>`EEEE 1001011 111 DDDDDDDDD 000000000` | D{,S/#} | C,Z | 2 | Alter subsequent GETWORD / ROLWORD instruction |
| **ALTI** | `EEEE 1001101 00I DDDDDDDDD SSSSSSSSS`<br>`EEEE 1001101 001 DDDDDDDDD 101100100` | D{,S/#} | C,Z | 2 | Substitute next instruction's field values from template, per configuration |
| **ALTR** | `EEEE 1001100 00I DDDDDDDDD SSSSSSSSS`<br>`EEEE 1001100 001 DDDDDDDDD 000000000` | D{,S/#} | C,Z | 2 | Alter Result register address of next instruction |
| **ALTS** | `EEEE 1001100 10I DDDDDDDDD SSSSSSSSS`<br>`EEEE 1001100 101 DDDDDDDDD 000000000` | D{,S/#} | C,Z | 2 | Alter S field of next instruction |
| **ALTSB** | `EEEE 1001011 00I DDDDDDDDD SSSSSSSSS`<br>`EEEE 1001011 001 DDDDDDDDD 000000000` | D{,S/#} | C,Z | 2 | Alter subsequent SETBYTE instruction |
| **ALTSN** | `EEEE 1001010 10I DDDDDDDDD SSSSSSSSS`<br>`EEEE 1001010 101 DDDDDDDDD 000000000` | D{,S/#} | C,Z | 2 | Alter subsequent SETNIB instruction |
| **ALTSW** | `EEEE 1001011 10I DDDDDDDDD SSSSSSSSS`<br>`EEEE 1001011 101 DDDDDDDDD 000000000` | D{,S/#} | C,Z | 2 | Alter subsequent SETWORD instruction |

## Smart Pin  (9)

| Mnemonic | Encoding | Operands | Flags | Cyc | Summary |
|----------|----------|----------|-------|-----|---------|
| **AKPIN** | `EEEE 1100000 01I 000000001 SSSSSSSSS` | S/# | C,Z | 2 | Acknowledge smart pin(s) |
| **GETSCP** | `EEEE 1101011 000 DDDDDDDDD 001110001` | D | C,Z | 2 | Get four-channel oscilloscope samples into D |
| **RDPIN** | `EEEE 1010100 C1I DDDDDDDDD SSSSSSSSS` | D,S/# | C,Z | 2 | Read smart pin result and acknowledge pin |
| **RQPIN** | `EEEE 1010100 C0I DDDDDDDDD SSSSSSSSS` | D,S/# | C,Z | 2 | Read smart pin result without acknowledge |
| **SETDACS** | `EEEE 1101011 00L DDDDDDDDD 000011100` | D/#0..511 | C,Z | 2 | DAC3 = D[31:24], DAC2 = D[23:16], DAC1 = D[15:8], DAC0 = D[7:0] |
| **SETSCP** | `EEEE 1101011 00L DDDDDDDDD 001110000` | D/#0..511 | C,Z | 2 | Set four-channel oscilloscope enable to D[6] and set input pin base to D[5:2] |
| **WRPIN** | `EEEE 1100000 0LI DDDDDDDDD SSSSSSSSS` | D/#,S/# | C,Z | 2 | Set mode of smart pins S[10:6]+S[5:0] |
| **WXPIN** | `EEEE 1100000 1LI DDDDDDDDD SSSSSSSSS` | D/#,S/# | C,Z | 2 | Set \"X\" of smart pins S[10:6]+S[5:0] |
| **WYPIN** | `EEEE 1100001 0LI DDDDDDDDD SSSSSSSSS` | D/#,S/# | C,Z | 2 | Set "Y" register of smart pins S[10:6]+S[5:0] |

## Streamer  (6)

| Mnemonic | Encoding | Operands | Flags | Cyc | Summary |
|----------|----------|----------|-------|-----|---------|
| **GETXACC** | `EEEE 1101011 000 DDDDDDDDD 000011110` | D | C,Z | 2 | Get streamer's Goertzel X/Y accumulators into D and next S |
| **SETXFRQ** | `EEEE 1101011 00L DDDDDDDDD 000011101` | D/#0..511 | C,Z | 2 | Set streamer NCO frequency to D |
| **XCONT** | `EEEE 1100110 0LI DDDDDDDDD SSSSSSSSS` | D/#,S/# | C,Z | 2 | Buffer new streamer command, continuing phase |
| **XINIT** | `EEEE 1100101 0LI DDDDDDDDD SSSSSSSSS` | D/#,S/# | C,Z | 2 | Issue streamer command immediately, zeroing phase |
| **XSTOP** | `EEEE 1100101 011 000000000 000000000` | operand_xlat | C,Z | 2 | Stop streamer immediately |
| **XZERO** | `EEEE 1100101 1LI DDDDDDDDD SSSSSSSSS` | D/#,S/# | C,Z | 2 | Buffer new streamer command, zeroing phase |
